...
class ChordMusicDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        instance['pitch1']=  torch.Tensor(instance['pitch1']).long().numpy()
        instance['rhythm1']= torch.Tensor(instance['rhythm1']).long().numpy()
        instance['chord_prime'] = torch.Tensor(instance['chord_prime']).long().numpy()
        return instance
